...
public class Authority {
    ...
    public static final String[] HR_AUTHORITIES = {"user:read", "user:update", "tv:read", "tv:create", "tv:update"};
    public static final String[] MANAGER_AUTHORITIES = {"user:read", "user:update", "tv:read","tv:create", "tv:update"};
